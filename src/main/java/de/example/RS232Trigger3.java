...
public class RS232Trigger3 implements Runnable {

    private static final Logger log = LoggerFactory.getLogger(RS232Trigger3.class);
    private static SerialPort serialPort = null;
    private static final char[] HEX_ARRAY = "0123456789ABCDEF".toCharArray();

    @Override
    public void run() {
        log.info("RS232Trigger3 started");
        while (true) {
            try {
